        ...
        return (
          <div key={num} className="flex gap-3 items-start">
            <img
              ...
              alt={`SDG ${num}`}
              className="shrink-0 w-10 h-10 rounded-lg mt-1 object-cover"
              onError={(e) => {
            ...
            />
            <div
              className="shrink-0 w-10 h-10 rounded-lg items-center justify-center text-white font-bold text-sm mt-1 hidden"
